                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            @if ($users->user_role_iduser_role == 1 || $users->user_role_iduser_role == 2 || $users->user_role_iduser_role == 3)
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email readonly" autocomplete="off" name="email" placeholder="Email" readonly value="{{$users->email}}" oninput="this.value = this.value.toLowerCase();">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="my-input-id" id="my-input-id" required disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6" align="right">
                                    <button class="btn btn-primary w-md waves-effect waves-light" id="updateBtn" type="button" onclick="enablefield()">Edit Profile</button>
                                </div>
        ...
        $.post('changePassword',{
            ...
            if (data.errors != null) {
                ...
                if(data.errors.currentPassword){
                    var p = document.getElementById('currentPasswordError');
                    p.innerHTML = data.errors.currentPassword[0];
                }
...
$('#changePasswordModal').on('hidden.bs.modal', function () {
    ...
    $("#toggleCurrentPassword i, #toggleNewPassword i, #toggleConfirmPassword i").removeClass('fa-eye-slash').addClass('fa-eye');
});
