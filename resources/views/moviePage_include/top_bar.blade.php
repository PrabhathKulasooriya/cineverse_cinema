                ...
                <nav id="navigation">
                    ...
                    <div class="nav-box navbar-collapse">
                        <ul class="navigation-menu nav navbar-nav navbars" id="nav">
                            <li data-menuanchor="slide01"><a href="{{ URL::asset('/')}}">Home</a></li>
                            <li data-menuanchor="slide02"><a href="{{ URL::asset('/#slide02')}}">Movies</a></li>
                            <li data-menuanchor="slide03"><a href="{{ URL::asset('/#slide03')}}">About Us</a></li>
                            <li data-menuanchor="slide04"><a href="{{ URL::asset('/#slide04')}}">Contact Us</a></li>
