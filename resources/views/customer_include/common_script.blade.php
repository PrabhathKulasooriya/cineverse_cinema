...
<script src="{{ \Illuminate\Support\Facades\URL::asset('user_assets/js/scrolloverflow.js')}}"></script>
<script src="{{ \Illuminate\Support\Facades\URL::asset('user_assets/js/owl.carousel.min.js')}}"></script>
